...
print("10-Fold Cross-Validation score:", gnb_cv)
...
print("10-Fold Cross-Validation score:", lr_cv)
...
print("10-Fold Cross-Validation score :", rf_cv)
...
legostic = metrics.accuracy_score(y_test, lr_predict_test)*100

DataFrame = len(df)
# lr_cv = metrics.accuracy_score(y_test, lr_predict_test)*100

df_results = pd.DataFrame.from_dict({
    'Accuracy Score':{'Naive Bayes':gnb_score_test, 'Logistic Regression':legostic, 'Random Forest':rf_score},
    'Cross-Validation Score':{'Naive Bayes':gnb_cv, 'Logistic Regression':lr_cv,  'Random Forest':rf_cv}
    })
df_results
